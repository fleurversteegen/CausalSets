...
public:
    ...
    Set(Spacetime);                   //construct a set based on a spacetime with a fixed nr of elements
   ...
   // void NN(Element&, ofstream& );    //finds the nearest neighbours of an element
    ...
    Element *GetTail();               //return the pointer to the tail Element
    
    Element *GetNode(int );           //return the pointer to the nth Element
